...
//        String source = "src\\main\\resources\\summaryreport.jrxml";
//        try {
//            JasperCompileManager.compileReportToFile(source);
//        } catch (JRException e) {
//            e.printStackTrace();
//        }
        String sourceFileName = "src\\main\\resources\\summaryreport.jasper";
        String printFileName = null;
        String destFileName = "src\\main\\resources\\sreport.pdf";
        JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(summaryService.summaryreport());
    ...
    public ResponseEntity<InputStreamResource> downloadFile1() throws IOException {
        ...
        String fileName="src\\\\main\\\\resources\\\\sreport.pdf";
